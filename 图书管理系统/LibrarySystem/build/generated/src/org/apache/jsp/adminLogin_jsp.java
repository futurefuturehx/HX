...
public final class adminLogin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                \n");
      out.write("                <!--&times啥意思-->\n");
      out.write("                <!--特殊字符都是用&来表示 这里乘号来代替叉叉 dismiss只是功能 乘号才是显示-->\n");
      ...
      out.write("                    <label class=\"control-label\" for=\"username\" style=\"display:none;\"></label>\n");
      out.write("                </div>\n");
      out.write("                <!--button包含在大框架中 但是不属于组-->\n");
      out.write("                <input type=\"button\" class=\"btn btn-lg btn-primary\" id=\"login_submit\" value=\"登&nbsp;&nbsp;&nbsp;&nbsp;录\"/>\n");
      out.write("            </form>\n");
      out.write("        </div>\n");
      out.write("    </div>\n");
      out.write("</div>\n");
      out.write("            <!--dismiss=\"modal\"啥意思-->\n");
      out.write("            <!--modal是模态框的意思-->\n");
      out.write("            <!--在不离开当前页面的情况下 提供一个来自单独源的内容 也就是一个弹出框\"-->\n");
      out.write("<div class=\"modal fade\" id=\"modal_info\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"addModalLabel\">\n");
      out.write("    <!--这么多的modal部分啥意思 有啥层次关系-->\n");
      out.write("    <!--前面几个大框架是必须的-->\n");
      out.write("    <!--modal-header是标题的内容的显示-->\n");
      out.write("    <!--modal-body是主要内容-->\n");
      out.write("    <!--modal-foot是按键内容-->\n");
      out.write("    \n");
      out.write("    <!--模糊框出发条件在哪里 触发源在哪里-->\n");
